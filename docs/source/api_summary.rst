...
Navigate using the links in the Navigation bar on the left side.
...
baserelswaps
This method uses the swapstatus API and displays base/rel swapstatus. Sample File Content:
