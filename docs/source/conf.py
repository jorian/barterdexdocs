...
# -*- coding: utf-8 -*-
#
# BarterDEX documentation build configuration file, created by
...
# documentation.
#
html_theme_options = {'canonical_url': 'http://barterdex.readthedocs.io/en/latest/',
   # 'analytics_id': '',
    #'logo_only': False,
...
htmlhelp_basename = 'BarterDEXdoc'
